export const newSheet = () => ({
  ...
  quirk: { name:'', type:'emissor', base:'dano', attribute:'Força', concept:'', weakness:'', path:'primario', presetId:'custom', nativeAbilities:[], manifestations:'', strategies:'', manifestationActivation:'inacao', awakenedManifestation:false, virtualPointsUsed:0, virtualPointsNotes:'' },
